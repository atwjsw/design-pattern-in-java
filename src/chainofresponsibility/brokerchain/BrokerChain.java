...
class Query {
    ...
    public Query(String creatueName, Argument argument, int result) {
        this.creatueName = creatueName;
...
implements AutoCloseable{
    ...
    public DoubleAttackModifier(Game game, Creature creature) {
        ...
        token = game.queries.subscribe(q -> {
            if (q.creatueName.equals(creature.name)
